...
///////////////////////////////////////////////////////////////////////////////
    ...
    public FirebaseBase(String baseUrl) throws FirebaseException {
     ...
     */
    public FirebaseBase(String baseUrl, Boolean useJsonExtension) throws FirebaseException {
        this(baseUrl);
        useJsonExt = useJsonExtension;
    }

    public FirebaseBase(String baseUrl, String secureToken) throws FirebaseException {
        if (baseUrl == null || baseUrl.trim().isEmpty()) {
            String msg = "baseUrl cannot be null or empty; was: '" + baseUrl + "'";
            LOGGER.error(msg);
            throw new FirebaseException(msg);
...
///////////////////////////////////////////////////////////////////////////////
    ...
    protected String buildFullUrlFromRelativePath(String path, NameValuePair[] queries) {
        ...
        if (useJsonExt) url += FirebaseBase.FIREBASE_API_JSON_EXTENSION;
